...
const BorderRadius br5 = BorderRadius.all(Radius.circular(5));
const BorderRadius br6 = BorderRadius.all(Radius.circular(6));
const BorderRadius br8 = BorderRadius.all(Radius.circular(8));
const BorderRadius br10 = BorderRadius.all(Radius.circular(10));
